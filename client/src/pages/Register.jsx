  ...
  return (
    ...
    <div className="registration-div">
      <div className="registration-container h-[100vh] w-full absolute top-0 z-20 flex justify-center items-center "  >
        ...
        <input onChange={handleChange} spellCheck="false" className='rounded-full p-1 px-8 outline-none ' required type="text" name='username' placeholder='Username' />
        </div>
        <div className='flex flex-col m-2 '>
        ...
        <div className='flex flex-col m-2 '>
        <label className='text-white my-1' htmlFor="Phone">Phone</label>
        <input onChange={handleChange} className='rounded-full p-1 px-8 outline-none' required type="text" name='phoneNo' placeholder='phone' />
        </div>
        <div className='flex flex-col m-2 '>
        ...
        <input className='mt-6 bg-blue-500 rounded-full px-8 py-2 text-white font-semibold text-center cursor-pointer focus:bg-blue-600 ' type="submit" value="Register Now" />
